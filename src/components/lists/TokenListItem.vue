<template>
  ...
  leading-5 opacity-0 highlight hover:bg-blue-50 hover:text-black dark:hover:bg-blue-900
  rounded-lg transition-colors ease-in duration-300`,
      {
        'bg-blue-50 text-black dark:bg-blue-900 border-blue-200 dark:border-blue-500':
          focussed,
      },
    ]"
  >
